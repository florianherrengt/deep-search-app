...
Cut a new release by triggering the "Publish Release" GitHub Actions workflow, which builds Tauri desktop binaries for macOS (x86_64 + aarch64) and Linux (x86_64) and uploads them as release assets.
...
- The workflow builds for 3 targets: `x86_64-apple-darwin`, `aarch64-apple-darwin`, `x86_64-unknown-linux-gnu`
